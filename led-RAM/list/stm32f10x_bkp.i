#line 1 "lib\\src\\stm32f10x_bkp.c"
...
#line 20 "lib\\src\\stm32f10x_bkp.c"
...
#line 21 "lib\\src\\stm32f10x_bkp.c"
...
void BKP_TamperPinLevelConfig(u16 BKP_TamperPinLevel)
{
  ...
  *(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x6C00) - ((u32)0x40000000)) + 0x30) * 32) + (0x01 * 4)) = BKP_TamperPinLevel;
}
...
void BKP_TamperPinCmd(FunctionalState NewState)
{
  ...
  *(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x6C00) - ((u32)0x40000000)) + 0x30) * 32) + (0x00 * 4)) = (u32)NewState;
}
...
void BKP_ITConfig(FunctionalState NewState)
{
  ...
  *(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x6C00) - ((u32)0x40000000)) + 0x34) * 32) + (0x02 * 4)) = (u32)NewState;
}
...
void BKP_RTCOutputConfig(u16 BKP_RTCOutputSource)
{
  ...
  tmpreg = ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->RTCCR;
  ...
  ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->RTCCR = tmpreg;
}
...
void BKP_WriteBackupRegister(u16 BKP_DR, u16 Data)
{
  ...
  *(vu16 *) ((((u32)0x40000000) + 0x6C00) + BKP_DR) = Data;
}
...
u16 BKP_ReadBackupRegister(u16 BKP_DR)
{
  ...
  return (*(vu16 *) ((((u32)0x40000000) + 0x6C00) + BKP_DR));
}
...
FlagStatus BKP_GetFlagStatus(void)
{
  return (FlagStatus)(*(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x6C00) - ((u32)0x40000000)) + 0x34) * 32) + (0x08 * 4)));
}
...
void BKP_ClearFlag(void)
{
  ...
  ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->CSR |= ((u16)0x0001);
}
...
ITStatus BKP_GetITStatus(void)
{
  return (ITStatus)(*(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x6C00) - ((u32)0x40000000)) + 0x34) * 32) + (0x09 * 4)));
}
...
void BKP_ClearITPendingBit(void)
{
  ...
  ((BKP_TypeDef *) (((u32)0x40000000) + 0x6C00))->CSR |= ((u16)0x0002);
}
