#line 1 "lib\\src\\stm32f10x_spi.c"
...
#line 20 "lib\\src\\stm32f10x_spi.c"
...
#line 21 "lib\\src\\stm32f10x_spi.c"
...
void SPI_I2S_ClearFlag(SPI_TypeDef* SPIx, u16 SPI_I2S_FLAG)
{
  ...
  else if ((SPI_I2S_FLAG == ((u16)0x0040)) || (SPI_I2S_FLAG == ((u16)0x0008)))  
  {
...
void SPI_I2S_ClearITPendingBit(SPI_TypeDef* SPIx, u8 SPI_I2S_IT)
{
  ...
  else if((SPI_I2S_IT == ((u8)0x56)) || (SPI_I2S_IT == ((u8)0x53)))    
  {
