#line 1 "lib\\src\\stm32f10x_dbgmcu.c"
...
#line 20 "lib\\src\\stm32f10x_dbgmcu.c"
...
u32 DBGMCU_GetREVID(void)
{
   return(((DBGMCU_TypeDef *) ((u32)0xE0042000))->IDCODE >> 16);
}
...
u32 DBGMCU_GetDEVID(void)
{
   return(((DBGMCU_TypeDef *) ((u32)0xE0042000))->IDCODE & ((u32)0x00000FFF));
}
...
void DBGMCU_Config(u32 DBGMCU_Periph, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((DBGMCU_TypeDef *) ((u32)0xE0042000))->CR |= DBGMCU_Periph;
  }
  else
  {
    ((DBGMCU_TypeDef *) ((u32)0xE0042000))->CR &= ~DBGMCU_Periph;
