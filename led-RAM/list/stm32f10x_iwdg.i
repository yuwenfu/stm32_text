...
#line 20 "lib\\src\\stm32f10x_iwdg.c"
...
void IWDG_WriteAccessCmd(u16 IWDG_WriteAccess)
{
  ...
  ((IWDG_TypeDef *) (((u32)0x40000000) + 0x3000))->KR = IWDG_WriteAccess;
}
...
void IWDG_SetPrescaler(u8 IWDG_Prescaler)
{
  ...
  ((IWDG_TypeDef *) (((u32)0x40000000) + 0x3000))->PR = IWDG_Prescaler;
}
...
void IWDG_SetReload(u16 Reload)
{
  ...
  ((IWDG_TypeDef *) (((u32)0x40000000) + 0x3000))->RLR = Reload;
}
...
void IWDG_ReloadCounter(void)
{
  ((IWDG_TypeDef *) (((u32)0x40000000) + 0x3000))->KR = ((u16)0xAAAA);
}
...
void IWDG_Enable(void)
{
  ((IWDG_TypeDef *) (((u32)0x40000000) + 0x3000))->KR = ((u16)0xCCCC);
}
...
FlagStatus IWDG_GetFlagStatus(u16 IWDG_FLAG)
{
  ...
  if ((((IWDG_TypeDef *) (((u32)0x40000000) + 0x3000))->SR & IWDG_FLAG) != (u32)RESET)
  {
    bitstatus = SET;
  }
  else
