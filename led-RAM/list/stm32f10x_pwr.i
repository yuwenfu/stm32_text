#line 1 "lib\\src\\stm32f10x_pwr.c"
...
#line 20 "lib\\src\\stm32f10x_pwr.c"
...
#line 21 "lib\\src\\stm32f10x_pwr.c"
...
void PWR_DeInit(void)
{
  RCC_APB1PeriphResetCmd(((u32)0x10000000), ENABLE);
  RCC_APB1PeriphResetCmd(((u32)0x10000000), DISABLE);
}
...
void PWR_BackupAccessCmd(FunctionalState NewState)
{
  ...
  *(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x7000) - ((u32)0x40000000)) + 0x00) * 32) + (0x08 * 4)) = (u32)NewState;
}
...
void PWR_PVDCmd(FunctionalState NewState)
{
  ...
  *(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x7000) - ((u32)0x40000000)) + 0x00) * 32) + (0x04 * 4)) = (u32)NewState;
}
...
void PWR_PVDLevelConfig(u32 PWR_PVDLevel)
{
  ...
  tmpreg = ((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CR;

   
  tmpreg &= ((u32)0xFFFFFF1F);

   
  tmpreg |= PWR_PVDLevel;

   
  ((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CR = tmpreg;
}
...
void PWR_WakeUpPinCmd(FunctionalState NewState)
{
  ...
  *(vu32 *) (((u32)0x42000000) + ((((((u32)0x40000000) + 0x7000) - ((u32)0x40000000)) + 0x04) * 32) + (0x08 * 4)) = (u32)NewState;
}
...
void PWR_EnterSTOPMode(u32 PWR_Regulator, u8 PWR_STOPEntry)
{
  ...
  *(vu32 *) ((u32)0xE000ED10) |= ((u32)0x00000004);
  
   
  if(PWR_STOPEntry == ((u8)0x01))
  {   
...
void PWR_EnterSTANDBYMode(void)
{
  ...
  ((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CR |= ((u32)0x00000004);

   
  ((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CR |= ((u32)0x00000002);
...
FlagStatus PWR_GetFlagStatus(u32 PWR_FLAG)
{
  ...
  if ((((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CSR & PWR_FLAG) != (u32)RESET)
  {
    bitstatus = SET;
  }
  else
...
void PWR_ClearFlag(u32 PWR_FLAG)
{
  ...
  ((PWR_TypeDef *) (((u32)0x40000000) + 0x7000))->CR |=  PWR_FLAG << 2;
}
