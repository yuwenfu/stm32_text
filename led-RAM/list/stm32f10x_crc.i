#line 1 "lib\\src\\stm32f10x_crc.c"
...
#line 20 "lib\\src\\stm32f10x_crc.c"
...
void CRC_ResetDR(void)
{
  ...
  ((CRC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x3000))->CR = ((u32)0x00000001);
}
...
u32 CRC_CalcCRC(u32 Data)
{
  ((CRC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x3000))->DR = Data;
  
  return (((CRC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x3000))->DR);
}
...
u32 CRC_CalcBlockCRC(u32 pBuffer[], u32 BufferLength)
{
  ...
  {
    ((CRC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x3000))->DR = pBuffer[index];
  }
...
void CRC_SetIDRegister(u8 IDValue)
{
  ((CRC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x3000))->IDR = IDValue;
}
...
u8 CRC_GetIDRegister(void)
{
  return (((CRC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x3000))->IDR);
}
