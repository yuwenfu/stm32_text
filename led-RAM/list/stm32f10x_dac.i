#line 1 "lib\\src\\stm32f10x_dac.c"
...
#line 20 "lib\\src\\stm32f10x_dac.c"
...
#line 21 "lib\\src\\stm32f10x_dac.c"
...
void DAC_DeInit(void)
{
  ...
  RCC_APB1PeriphResetCmd(((u32)0x20000000), ENABLE);
   
  RCC_APB1PeriphResetCmd(((u32)0x20000000), DISABLE);
}
...
void DAC_Init(u32 DAC_Channel, DAC_InitTypeDef* DAC_InitStruct)
{
  ...
  tmpreg1 = ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR;
   
  tmpreg1 &= ~(((u32)0x00000FFE) << DAC_Channel);
  ...
  ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR = tmpreg1;
}
...
void DAC_StructInit(DAC_InitTypeDef* DAC_InitStruct)
{
  ...
  DAC_InitStruct->DAC_Trigger = ((u32)0x00000000);

   
  DAC_InitStruct->DAC_WaveGeneration = ((u32)0x00000000);

   
  DAC_InitStruct->DAC_LFSRUnmask_TriangleAmplitude = ((u32)0x00000000);

   
  DAC_InitStruct->DAC_OutputBuffer = ((u32)0x00000000);
}
...
void DAC_Cmd(u32 DAC_Channel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR |= ((u32)0x00000001) << DAC_Channel;
  }
  else
  {
...
void DAC_DMACmd(u32 DAC_Channel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR |= ((u32)0x00001000) << DAC_Channel;
  }
  else
  {
...
void DAC_SoftwareTriggerCmd(u32 DAC_Channel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->SWTRIGR |= ((u32)0x00000001) << (DAC_Channel >> 4);
  }
  else
  {
...
void DAC_DualSoftwareTriggerCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->SWTRIGR |= ((u32)0x00000003) ;
  }
  else
  {
     
    ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->SWTRIGR &= ((u32)0xFFFFFFFC);
  }
}
...
void DAC_WaveGenerationCmd(u32 DAC_Channel, u32 DAC_Wave, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((u32)0x40000000) + 0x7400))->CR |= DAC_Wave << DAC_Channel;
  }
  else
  {
...
void DAC_SetChannel1Data(u32 DAC_Align, u16 Data)
{
  ...
  *((vu32 *)((((u32)0x40000000) + 0x7400) + ((u32)0x00000008) + DAC_Align)) = (u32)Data;
}
...
void DAC_SetChannel2Data(u32 DAC_Align, u16 Data)
{
  ...
  *((vu32 *)((((u32)0x40000000) + 0x7400) + ((u32)0x00000014) + DAC_Align)) = (u32)Data;
}
...
void DAC_SetDualChannelData(u32 DAC_Align, u16 Data2, u16 Data1)
{
  ...
  *((vu32 *)((((u32)0x40000000) + 0x7400) + ((u32)0x00000020) + DAC_Align)) = Data;
}
...
u16 DAC_GetDataOutputValue(u32 DAC_Channel)
{
  ...
  return (u16) (*(vu32*)((((u32)0x40000000) + 0x7400) + ((u32)0x0000002C) + ((u32)DAC_Channel >> 2)));
}
