#line 1 "lib\\src\\stm32f10x_i2c.c"
...
#line 20 "lib\\src\\stm32f10x_i2c.c"
...
#line 21 "lib\\src\\stm32f10x_i2c.c"
...
void I2C_DeInit(I2C_TypeDef* I2Cx)
{
  ...
  switch (*(u32*)&I2Cx)
  {
    case (((u32)0x40000000) + 0x5400):
       
      RCC_APB1PeriphResetCmd(((u32)0x00200000), ENABLE);
       
      RCC_APB1PeriphResetCmd(((u32)0x00200000), DISABLE);
      break;

    case (((u32)0x40000000) + 0x5800):
       
      RCC_APB1PeriphResetCmd(((u32)0x00400000), ENABLE);
       
      RCC_APB1PeriphResetCmd(((u32)0x00400000), DISABLE);
      break;
...
void I2C_Init(I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  {
    if (I2C_InitStruct->I2C_DutyCycle == ((u16)0xBFFF))
    {
    ...
    if ((result & ((u16)0x0FFF)) == 0)
    {
       
      result |= (u16)0x0001;  
    }
     
    tmpreg |= result | ((u16)0x8000);
...
void I2C_StructInit(I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  I2C_InitStruct->I2C_Mode = ((u16)0x0000);

   
  I2C_InitStruct->I2C_DutyCycle = ((u16)0xBFFF);

   
  I2C_InitStruct->I2C_OwnAddress1 = 0;

   
  I2C_InitStruct->I2C_Ack = ((u16)0x0000);

   
  I2C_InitStruct->I2C_AcknowledgedAddress = ((u16)0x4000);
...
void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->OAR2 |= ((u16)0x0001);
  }
  else
  {
     
    I2Cx->OAR2 &= ((u16)0xFFFE);
  }
}
...
FlagStatus I2C_GetFlagStatus(I2C_TypeDef* I2Cx, u32 I2C_FLAG)
{
  ...
  flag1 = I2Cx->SR1;
  flag2 = I2Cx->SR2;
  flag2 = (flag2 & ((u32)0x00FFFFFF)) << 16;

   
  i2cstatus = flag1 | flag2;

   
  I2C_FLAG &= ((u32)0x00FFFFFF);
...
void I2C_ClearFlag(I2C_TypeDef* I2Cx, u32 I2C_FLAG)
{
  ...
  flagpos = I2C_FLAG & ((u32)0x00FFFFFF);
